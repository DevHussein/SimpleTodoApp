            ...
            >
              ...
              <Card.Body className="gap-4">
                ...
                >
                  ...
                  <Switch
                    isSelected={isCompletedOnCreate}
                    onPress={() => setIsCompletedOnCreate(!isCompletedOnCreate)}
                    isDisabled={isCreatingTodo}
                    accessibilityLabel={t('todoForm.markCompleted')}
                    className={`${isCompletedOnCreate ? 'bg-accent' : 'bg-switchTrackOff'}`}
                  />
                </View>
